...
public abstract class VRTK_WorldPointer : MonoBehaviour {
    ...
    {
        //Added code
        var controller = GameObject.FindObjectOfType<SteamVR_ControllerManager>().left;
        //
        ...
        controller.GetComponent<VRTK_ControllerEvents>().AliasPointerOn += new ControllerClickedEventHandler(EnablePointerBeam);
        controller.GetComponent<VRTK_ControllerEvents>().AliasPointerOff += new ControllerClickedEventHandler(DisablePointerBeam);
